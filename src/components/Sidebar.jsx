    ...
    return (
        ...
        <div id='sideNavbar'>
          ...
          <hr style={{display: isOpen ? "block" : "none"}}/>
            ...
            <NavLink to='/dashboard' key='1' className="link" activeclassname="active">
            <div style={{width: isOpen ?'200px':'7px'}} className="first">
                <div>
            ...
            <NavLink to='/jobcard' key='2' className="link" activeclassname="active">
            <div style={{width: isOpen ?'200px':'7px'}} id='two' className="second">
                <img className="sImg" src={job} alt=""/>
                <p style={{display: isOpen ? "block" : "none"}} className="sP">jobcard</p>
            </div>
            </NavLink>
            <NavLink to='/master' key='3' className="link" activeclassname="active">
            <div style={{width: isOpen ?'200px':'7px'}} className="third">
                <img className="tImg" src={master} alt=""/>
                <p style={{display: isOpen ? "block" : "none"}} className="tP">Master</p>
            </div>
            </NavLink>
            <NavLink to='/timeline' key='4' className="link" activeclassname="active">
            <div style={{width: isOpen ?'200px':'7px'}} className="forth">
                <img className="forthImg" src={timeline} alt=""/>
                <p style={{display: isOpen ? "block" : "none"}} className="forthP">Timeline</p>
            </div>
            </NavLink>
            <NavLink to='/datainjestion' key='5' className="link" activeclassname="active">
            <div style={{width: isOpen ?'200px':'7px'}} className="fifth">
            ...
            <NavLink to='/qaqc' key='6' className="link" activeclassname="active">
            <div style={{width: isOpen ?'200px':'7px'}} className="sixth">
                <p style={{display: isOpen ? "block" : "none"}} className="sixthP">QA/QC</p>
            </div>
            </NavLink>
            <NavLink to='/usermanagement' key='7' className="link" activeclassname="active">
            <div style={{width: isOpen ?'200px':'7px'}} className="seventh">
                <p style={{display: isOpen ? "block" : "none"}} className="seventhP">User Management</p>
            </div>
            </NavLink>
            <button onClick={()=>navigate('/')} className='sSignout'>Sign Out</button>
